...
public class RahulAssignment2 {
    ...
    private By roundTripBy = By.id("RoundTrip");
    private By departOnBy = By.id("DepartDate");
    private By nextMonthBy = By.xpath("//div[@id='ui-datepicker-div']/div[2]/div/a");
    private By departDaySelect = By.xpath("(//tbody/tr/td/a[text()='28'])[1]");
    private By returnDaySelect = By.xpath("//tbody/tr/td/a[text()='13']");
...
//        alert.dismiss();
        BrowserUtils.wait(2);
        driver.findElement(roundTripBy).click();
        BrowserUtils.wait(2);
        driver.findElement(departOnBy).click();
        BrowserUtils.wait(2);
        for(int i = 1 ; i < 3 ; i++){
            driver.findElement(nextMonthBy).click();
            BrowserUtils.wait(2);
        }
        driver.findElement(departDaySelect).click();
        BrowserUtils.wait(2);
        driver.findElement(returnDaySelect).click();
        BrowserUtils.wait(2);
